...
export default function PlaceGallery({place}) {
        ...
        return (
            <div className="absolute inset-0 bg-black text-white min-h-full">
                <div className="bg-black p-8 grid gap-4">
                    <div>
                        <h2 className="lg:text-3xl lg:text-center underline">Photos of {place.title}</h2>
                        <button onClick={()=>setShowAllPhotos(false)} className="flex fixed bottom-8 right-12 gap-1 py-2 px-4 rounded-2xl shadow shadow-black bg-white text-black">
                    ...
                    {place?.photos?.length > 0 && place.photos.map(photo => (
                        <div className="h-2/3 w-2/3 mx-auto">
    ...
    return (
        <div className="relative h-2/3 w-3/4 mx-auto">
            ...
            <button onClick={()=>setShowAllPhotos(true)} className="gap-1 flex absolute lg:bottom-2  -bottom-12 right-0 lg:right-2 py-2 px-4 bg-white rounded-2xl shadow shadow-md shadow-gray-500">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
