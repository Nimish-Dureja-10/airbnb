    ...
    return (
        <>
            <div className="flex gap-2">
                <input type={'text'} placeholder="Add using a link ...jpg or jpeg" value={photoLink} onChange={(ev)=>setPhotoLink(ev.target.value)} />
                <button className="bg-gray-200 px-4 rounded-2xl" onClick={addPhotoByLink} >Add&nbsp;Photo</button>
            </div>
            <div className="mt-2 gap-2 grid grid-cols-3 md:grid-col-4 lg:grid-col-6">
