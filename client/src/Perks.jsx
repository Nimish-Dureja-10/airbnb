export default function Perks({selected,onChange}){
    ...
    return (
        <>
            ...
            <label className="border p-4 flex gap-2 rounded-2xl items-center cursor-pointer">
                <input type={'checkbox'} checked={selected.includes('garden')} name="garden" onChange={handleCbClick}/>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <label className="border p-4 flex gap-2 rounded-2xl items-center cursor-pointer">
                <input type={'checkbox'} checked={selected.includes('mountain')} name="mountain" onChange={handleCbClick}/>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
